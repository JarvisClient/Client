...
const TestReport: React.FC<ConsoleViewProps> = ({ buildData }) => {
    ...
    let [testReport, setTestReport] = useState<any>(null);
    ...
    useEffect(() => {
        const fetchTestReport = async () => {
            try {
                let storedProjectName: string = localStorage.getItem("projectName") || "";                

                let json = await fetchTestData(storedProjectName, buildData["id"]);
