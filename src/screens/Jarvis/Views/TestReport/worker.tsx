...
import { TestCase, TestSuite } from "../../../../Interfaces/ITestReport";

export function renderTestReportCard(suite: TestSuite): React.JSX.Element[] {
	return suite.cases.map((testcase: TestCase) => (
