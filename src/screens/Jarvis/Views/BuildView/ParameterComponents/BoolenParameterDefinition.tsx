...
const BooleanParameterDefinition: React.FC<Props> = ({ parameters, value, onChange }): React.JSX.Element => {
	...
	useEffect(() => {
		const defaultValue = typeof parameters.defaultParameterValue.value === "boolean" ? parameters.defaultParameterValue.value : String(parameters.defaultParameterValue.value);
