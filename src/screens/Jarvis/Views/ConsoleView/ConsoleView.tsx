		...
		<div className="mx-10 my-10">
			{buildData && !isLoading
				? (
					<>
						<div
							className={`fixed w-14 h-14 rounded-full flex justify-center items-center bottom-10 right-10 bg-opacity-50 backdrop-blur-md transition-all invert select-none ${bottomLock ? "bg-green-500 scale-[1]" : "bg-red-500 scale-[0.85]"}`}
