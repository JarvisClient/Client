...
const ErrorView: React.FC<Props> = ({ error, errorInfo, file_path }): React.JSX.Element => {
	...
	return (
		<div>
			...
			<div className="flex flex-col bg-background-sidebar items-center justify-center h-screen overflow-x-hidden select-none">
				<div className="flex flex-col items-center text-center mb-10">
					...
					<p className="mb-8 w-2/3 break-all"> Well, that's embarrassing. <br /> It seems Jarvis encountered a Runtime Error, which has been logged to <b>{file_path}</b>.<br />If this occurs again, please consider reporting it to the Team.</p>
					<div className="w-2/3">
