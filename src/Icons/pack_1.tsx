...
export const IcoMaximize = ({ size = 24, color = "currentColor", className }: IconProps) => (
	<svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none">
		<path d="M12.8166 18H7C6.44772 18 6 17.5523 6 17V11.1834C6 10.2925 7.07714 9.84637 7.70711 10.4763L13.5237 16.2929C14.1536 16.9229 13.7075 18 12.8166 18Z" fill={color} />
		<path d="M11.1834 6.00001L17 6.00001C17.5523 6.00001 18 6.44772 18 7.00001L18 12.8166C18 13.7075 16.9229 14.1536 16.2929 13.5237L10.4763 7.70711C9.84637 7.07715 10.2925 6.00001 11.1834 6.00001Z" fill={color} />
	</svg>
);
